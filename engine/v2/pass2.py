...
class Pass2Pipeline:
    ...
    def render_writing_prompt(
        ...
        writing_input = {
            ...
            "pass1_user_reading": request["frozen_pass1"]["payload"]["user_display"],
    ...
    def assemble(
        ...
        output = {
            ...
            "question_activation": integration_stage["question_activation"],
            "reality_evidence": integration_stage["reality_evidence"],
            "situated_traditional_reading": dict(situated_output),
            "situated_compensation": integration_stage["situated_compensation"],
            "integrated_third_meaning": integration_stage["integrated_third_meaning"],
