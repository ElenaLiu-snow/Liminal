...
1. 盲态发现与具体问题的交点
2. 问题表达的变化及其意义（如有）
3. situated traditional reading
4. 最终第三意义
5. 1–3 句非预测性的方向回答
6. 一个具体的带走问题
...
3. 荣格解释 prompt：读取冻结事实与关系，生成有证据边界的心理假设
4. 补偿整合：读取 canonical traditional reading，生成牌的补偿与暂时的第三意义
5. 为各步骤分别建立 schema 校验与回归样本
6. Pass 1 冻结后直接写作并展示
...
5. 明确盲态发现与问题后连接
6. 输出问题变化、最终第三意义、方向回答和结尾问题
7. 检查 Pass 2 是否覆盖、复述或偷改 Pass 1
